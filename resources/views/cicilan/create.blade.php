<div class="modal fade" id="addCicilan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="bg-dark modal-content">
            <div class="modal-header bg-gray-100 border-0">
                <h5 class="modal-title text-white">Pengulangan</h5>
                <button class="close text-white" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="transaction" method="POST" action="{{ route('cicilans.store') }}">
                    @csrf
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user @error('nama') is-invalid @enderror"
                            name="nama" value="{{ old('nama') }}" placeholder="Nama Pengulangan">
                        @error('nama')
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user @error('tanggal') is-invalid @enderror"
                    ...
                    <div class="mb-3 hide-inputbtns input-group">
                        <input type="text" maxlength="2"
                            ...
                            value="{{ old('bulan') }}" placeholder="Berapa Bulan Pengulangan" required>
