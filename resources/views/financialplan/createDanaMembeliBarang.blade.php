<div class="modal fade" id="DanaMembeliBarang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="bg-dark  modal-content">
            ...
            <div class="modal-body">
                <form id="addDanaMembeliBarang" method="POST" action="{{ route('financialplans.danabelibarang') }}">
                    @csrf
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user @error('nama') is-invalid @enderror"
                            name="nama" value="{{ old('nama') }}" placeholder="Nama Barang" required>
                        @error('nama')
                    ...
                    <div class="mb-3 hide-inputbtns input-group">
                        ...
                        <input data-number-stepfactor="100" type="number" name="target" value="{{ old('target') }}"
                            required placeholder="Harga Barang Saat Ini"
                    ...
                    <div class="mb-3 hide-inputbtns input-group">
                        <input type="text" maxlength="2"
                            ...
                            value="{{ old('bulan') }}" placeholder="Berapa lama lagi Anda akan membeli" required>
                    ...
                    <div class="mb-3 hide-inputbtns input-group">
                        ...
                        <input data-number-stepfactor="100" type="number" name="jumlah" value="{{ old('jumlah') }}"
                            required placeholder="Dana yang telah tersedia"
