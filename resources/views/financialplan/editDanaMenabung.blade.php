    ...
    <div class="modal-dialog" role="document">
        <div class="bg-dark  modal-content">
            <div class="modal-header bg-gray-100 border-0">
                <h5 class="modal-title text-white">Dana Menabung Rutin</h5>
            ...
            <div class="modal-body">
                <form id="formeditmodal-{{ $financialplan->id }}" method="POST"
                    action="{{ route('financialplans.danamenabung.update', $financialplan) }}">
                    @csrf
                    <div class="mb-3 hide-inputbtns input-group">
                        ...
                        <input data-number-stepfactor="100" type="number" name="target"
                            value="{{ old('target') ?? $financialplan->dana_awal }}" required
                            placeholder="Dana yang mau diinvestasi"
                    ...
                    <div class="mb-3 hide-inputbtns input-group">
                        ...
                        <input data-number-stepfactor="100" type="number" name="jumlah"
                            ...
                            placeholder="Tambahaan Investasi Setiap Bulan"
                    ...
                    <div class="mb-3 hide-inputbtns input-group">
                        <input type="text" maxlength="2"
                            ...
                            value="{{ old('bulan') ?? $financialplan->bulan }}" placeholder="Investasi berapa lama"
                            required>
