    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal" data-toggle="modal"
                    data-target="#addRekening2">Cancel</button>
...
<div class="modal fade" id="addRekening2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Modal 2 Coba</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <input type="text" class="form-control form-control-user @error('nama') is-invalid @enderror"
                        name="nama2" value="{{ old('nama2') }}" required aria-describedby="emailHelp"
                        placeholder="Utang ke Siapa">
                    @error('nama2')
                        <script>
                            $('#addRekening').modal('show');
                ...
                <div class="form-group" id="kategori">
                    <input type="number" class="form-control form-control-user @error('jumlah') is-invalid @enderror"
                        name="jumlah2" value="{{ old('jumlah2') }}" required aria-describedby="emailHelp"
                        placeholder="Jumlah">
                    @error('jumlah2')
                        <script>
                            $('#addRekening').modal('show');
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user @error('keterangan2') is-invalid @enderror"
                        name="keterangan2" value="{{ old('keterangan2') }}" aria-describedby="emailHelp"
                        placeholder="keterangan2">
                    @error('keterangan2')
                        <script>
                            $('#addRekening').modal('show');
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary"
                    onclick="event.preventDefault();document.getElementById('rekening').submit();document.getElementById('rekening2').submit();">Add</a>
